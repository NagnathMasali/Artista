<%-- 
    Document   : imgController
    Created on : Nov 9, 2017, 11:00:31 PM
        ...
        <%!
         ...
         <%
            ...
            try
           {
            ...
            stt.execute("INSERT INTO `drawpath`(`impath`, `description`) VALUES ('"+str+"','"+inpun+"')");
            ...
            response.sendRedirect("../view/DrawingShow.jsp");
         %>
